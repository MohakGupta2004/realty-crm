...
export default function Sidebar() {
  ...
  return (
    <div className="w-50 flex flex-col h-full">
      ...
      <div className="px-3 py-3 text-sm text-gray-900">Workspace</div>
      ...
      {user && (
        <div className="border-t mt-auto">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:bg-gray-200 rounded-md mx-2 my-1"
          >
